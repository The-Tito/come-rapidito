...
// =================== SUBMIT FORM ===================
document.querySelector('formAgregarProducto').addEventListener('submit', async function(event) {
  event.preventDefault();
  const form = e.target;
  console.log("estoy en add product despues de submit")
  ...
  formData.append("id_restaurante", 3);
